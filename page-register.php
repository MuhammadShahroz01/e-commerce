            ...
            <div id="title" class="page-title">
                <div class="section-container">
                    ...
                    <div class="breadcrumbs">
                        <a href="index.php">Home</a><span class="delimiter"></span>Register
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="box-form-login">
                                        ...
                                        <div class="box-content">
                                            <div class="form-register">
                                                <form method="post" class="register"  action="page-login.php">
                                                    <div class="email">
                                                    ...
                                                    <div class="button-register">ALREADY HAVE AN ACCOUNT? 
                                                        <a href="page-login.php" class="button-next-reregister">LOGIN</a>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
