                                ...
                                <div class="row">
                                    <div class="col-md-4 sm-m-b-30">
                                        <div class="info-item">
                                            ...
                                            <span>Phone:</span> <a href="tel:8889990000">+1234567890</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 sm-m-b-30">
                                        <div class="info-item">
                                            ...
                                            <div class="item-content">
                                                <!-- info@gmail.com -->
                                                <span>Email:</span> <a href="mailto:support@mojuri.com">info@gmail.com</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="info-item">
                                            ...
                                            <div class="item-content">
                                                ...
                                                <span>Head Office:</span> <span style="color: #000000;">House 1 Street 1 Country</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="block block-contact-form">
                                <div class="block-widget-wrap">
                                    ...
                                    <div class="block-content">
                                        <form action="final_email/email/mail.php" method="post" class="contact-form" novalidate="novalidate">
                                            <div class="contact-us-form">
                                                ...
                                                <div class="form-button">
                                                    <input type="submit" name="send" value="Send Message" class="button"></span>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
