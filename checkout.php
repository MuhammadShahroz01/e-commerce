            ...
            <div id="title" class="page-title">
                <div class="section-container">
                    ...
                    <div class="breadcrumbs">
                        <a href="index.php">Home</a><span class="delimiter"></span>Checkout
                    </div>
                </div>
            </div>
                ...
                <div class="section-padding">
                    <div class="section-container p-l-r">
                        <div class="shop-checkout">
                            <form name="checkout" method="post" class="checkout" action="confirm.php">
                                <div class="row">
                                        ...
                                        <div class="checkout-review-order">
                                            ...
                                            <div id="payment" class="checkout-payment">
                                                ...
                                                <div class="form-row place-order">
                                                    ...
                                                    <a href="confirm.php"><button class="button alt" name="checkout_place_order" value="Place order">Place order</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
